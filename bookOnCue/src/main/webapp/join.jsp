...
%>
	<form method="post" action="JoinPro.jsp">
		...
		phone:<input type="text" id="phone1" name="phone1" maxlength="3" placeholder="000" style="color: #aaa" required>-<input type="text" id="phone2" name="phone2" maxlength="4" placeholder="0000" style="color: #aaa" required>-<input type="text" id="phone3" name="phone3" maxlength="4" placeholder="0000" style="color: #aaa" required><br>
